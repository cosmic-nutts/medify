    ...
    return (
        <form className='min-h-[80vh] flex items-center '>
          <div className='flex flex-col gap-3 items-start m-auto p-8  min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
            ...
            {
              state=== "Sign Up"
              ? <p>Already have an account ? <span onClick={()=>setState('Login')} className='text-green underline cursor-pointer'>Login here</span></p>
              : <p>Create new account? <span onClick={()=>setState('Sign Up')}  className='text-green underline cursor-pointer'>Click here</span></p>
            }
          </div>
